...
Route::post('/post/destroy', [App\Http\Controllers\PostsController::class, 'destroy'])->middleware('auth')->name('post.destroy');
Route::post('/comment/destroy', [App\Http\Controllers\CommentsController::class, 'destroy'])->middleware('auth')->name('comment.destroy');
